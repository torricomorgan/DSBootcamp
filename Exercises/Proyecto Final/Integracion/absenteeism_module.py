...
class absenteeism_model():
        ...
        def load_and_clean_data(self, data_file):
            ...
            column_names = ['Date', 'TransportationExpense', 'DistanceToWork', 'Age',
            ...
            column_names_reordered = ['Reason_1', 'Reason_2', 'Reason_3', 'Reason_4', 'Date', 'TransportationExpense', 
                                      'DistanceToWork', 'Age', 'DailyWorkLoadAverage', 'BodyMassIndex', 'Education', 
            ...
            df['MonthValue'] = list_months

            # create a new feature called 'Day of the Week'
            df['DayOfTheWeek'] = df['Date'].apply(lambda x: x.weekday())
            ...
            # re-order the columns in df
            column_names_upd = ['Reason_1', 'Reason_2', 'Reason_3', 'Reason_4', 'MonthValue', 'DayOfTheWeek',
                                'TransportationExpense', 'DistanceToWork', 'Age',
                                'DailyWorkLoadAverage', 'BodyMassIndex', 'Education', 'Children',
